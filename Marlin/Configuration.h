...
#define STRING_CONFIG_H_AUTHOR "(Michael, t3chguy)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51.0, -6.5, 0 }
...
#define Z_PROBE_SPEED_FAST _HOMING_FEEDRATE_Z
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 33
...
#define _HOMING_FEEDRATE_Z 15 * 60
#define HOMING_FEEDRATE_MM_M { (80*60), (80*60), _HOMING_FEEDRATE_Z }
